defmodule Inconn2Service.Repo.Migrations.AddPartialUniqueIndex do
  ...
  def change do
    ...
    drop index("employees", [:employee_id])
    ...
    create unique_index(:employees, [:employee_id, :email], where: "active = 'true'", name: :unique_employee_id)
    create unique_index(:employees, [:email], where: "active = 'true'", name: :unique_employee_email)
    create unique_index(:users, [:username], where: "active = 'true'", name: :unique_users_username)
    create unique_index(:users, [:email], where: "active = 'true'", name: :unique_users_email)
