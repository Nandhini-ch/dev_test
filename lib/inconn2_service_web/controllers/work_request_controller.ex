defmodule Inconn2ServiceWeb.WorkRequestController do
  ...
  def index_for_approval_pending(conn, _) do
    work_requests = Ticket.list_work_requests_sent_for_approval(conn.assigns.current_user, conn.assigns.sub_domain_prefix)
    render(conn, "index.json", work_requests: work_requests)
  end
