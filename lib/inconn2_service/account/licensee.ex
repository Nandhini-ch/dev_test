defmodule Inconn2Service.Account.Licensee do
  ...
  schema "licensees" do
    ...
    field :party_type, {:array, :string}, default: ["AO", "SELF"]
    field :other_party_type, :string
  ...
  def changeset(licensee, attrs) do
    licensee
    |> cast(attrs, [:company_name, :business_type_id, :sub_domain, :party_type, :other_party_type])
