defmodule Inconn2Service.Dashboards.DashboardCharts do
  ...
  def get_consumption_for_all_submeters(params, prefix) do
    date_list = form_date_list_from_iso(params["from_date"], params["to_date"], params["site_id"], prefix)

    date_list
    |> Enum.map(&Task.async(fn -> get_individual_consumption_for_all_submeters_assets(&1, params, prefix) end))
    |> Enum.map(&Task.await/1)
  end
  ...
  defp get_individual_consumption_for_all_submeters_assets(date, params, prefix) do
