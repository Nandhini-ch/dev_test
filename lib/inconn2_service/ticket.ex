defmodule Inconn2Service.Ticket do
  ...
  def create_work_request(attrs \\ %{}, prefix, user \\ %{id: nil}) do
    ...
    case created_work_request do
      {:ok, work_request} ->
        ...
        Elixir.Task.start(fn -> push_alert_notification_for_new_ticket(work_request, prefix, work_request.site_id, user) end)
  ...
  def push_alert_notification_for_new_ticket(work_request, prefix, site_id, user) do
    ...
    generate_alert_notification("NTGEN", site_id, [work_request_type, work_request.id, current_user, date_time], [work_request_type, work_request.id, current_user, date_time], user_maps, [], prefix)
  ...
  def push_alert_notification_for_ticket(asset_id, asset_type, workrequest_category_id, existing_work_request, updated_work_request, prefix, site_id, user) do
    ...
    cond do
      ...
      existing_work_request.status != updated_work_request.status and updated_work_request.status == "CL" ->
        ...
        user_maps = Staff.form_user_maps_by_user_ids([updated_work_request.requested_user_id], prefix)
