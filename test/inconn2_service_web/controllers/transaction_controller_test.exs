defmodule Inconn2ServiceWeb.TransactionControllerTest do
  ...
  def fixture(:transaction) do
    {:ok, transaction} = InventoryManagement.create_transaction(@create_attrs)
    transaction
  end
